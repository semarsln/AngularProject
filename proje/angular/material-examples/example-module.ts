...
} from "./dialog-data/dialog-data-example";
import {
...
export const EXAMPLE_COMPONENTS: { [key: string]: LiveExample } = {
  ...
  "cdk-popover-edit-tab-out-vanilla-table": {
    title:
      "CDK Popover Edit with spreadsheet-like configuration on an HTML data-table",
  ...
  "popover-edit-cell-span-mat-table": {
    title:
      "Material Popover Edit spanning multiple columns on a Material data-table",
  ...
  "popover-edit-tab-out-mat-table": {
    title:
      "Material Popover Edit with spreadsheet-like configuration on a Material data-table",
